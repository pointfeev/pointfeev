...
| [Tic-Tac-Toe Kotlin](https://github.com/pointfeev/TicTacToeKotlin) | A terminal-based Tic-Tac-Toe game with a server and clients communicating via TCP/IP sockets; developed for the purpose of learning and testing out Kotlin and Gradle (and for fun). |
